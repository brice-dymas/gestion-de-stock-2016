<%--
    Document   : edit
    Created on : 11 déc. 2015, 09:47:01
...
<tiles:insertDefinition name="layout">
    <tiles:putAttribute name="body">
        ...
        <spring:url value="/audit/${auditForm.audit.id}/update" var="audit_update" htmlEscape="true" />

        <form:form method="post" commandName="auditForm" action="${audit_update}?${_csrf.parameterName}=${_csrf.token}">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <form:input id="observation" path="audit.observation" cssClass="form-control input-sm"/>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <form:hidden path="audit.id" id="id"/>
                    </div>
                </div>
            </div>
            <hr/>
