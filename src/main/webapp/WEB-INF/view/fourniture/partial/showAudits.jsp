<%--
    Document   : showAudits
    Created on : 11 mars 2016, 09:23:02
...
<fieldset>
    ...
    <table class="table table-bordered">
        <thead>
            <tr class="btn-primary">
                ...
                <th><spring:message code="departement.intitule" /></th>
    ...
    <c:if test="${0 ne ligneOperations.size()}" >
        <c:forEach var="ligneOperation" items="${ligneOperations}">
            <tr>
                <td> <fmt:formatDate value="${ligneOperation.operation.dateOperation}" pattern="dd/MM/yyyy" /> </td>
        ...
        function queryLigneOperation(href) {
            ...
            $.get(url, function (data) {
                $.each(data["ligneOperations"], function (index, value) {
                    ...
                    row += "<td>" + data["operation"]['dateOperation'] + "</td>";
                    row += "<td>" + data["departement"]['intitule'] + "</td>";
